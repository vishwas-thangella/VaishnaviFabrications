                    ...
                    <div className="col-12 members">
                        <h1 className='mt-3'>Dream homes begin with dream designs.</h1>
                            ...
                            <div className={IsMobileView ? 'serItem-mb' : 'serItem'}>
                                ...
                                <p>The Studco Steel Stud Framing System is available in Australia and New Zealand only. It is engineered to provide the ideal solution to create durable and versatile framing systems that also achieve the needs and design criteria in accordance with the Building Code of Australia (BCA) and the New Zealand Building Code (NZBC).</p>
                            </div>
                            <div className={IsMobileView ? 'serItem-mb' : 'serItem'}>
                        ...
                        <div className="col-12 contact">
                            ...
                            <div style={{display:"flex",justifyContent:"center",flexDirection:"row",alignItems:"center",gap:"20px"}} className="pb-4">
                                <div style={{display:"flex",alignItems:"center",gap:"10px"}}>
                                    ...
                                    <h6 className='text-black mt-4'>+91 9000552347</h6>
                                </div>
                                <div style={{display:"flex",alignItems:"center",gap:"10px"}}>
